...
class BluetoothConnector {
  ...
  Future<bool> stopScanBtDevices() async {
    return await _channel.invokeMethod("stopScanBtDevices");
  }
  ...
  Future<bool> toggleBlutoothConnection() async {
    return await _channel.invokeMethod("toggleConnection");
  }
